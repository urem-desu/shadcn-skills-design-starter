...
| Build/modify UI with shadcn/ui + Tailwind v4 from the Figma-synced tokens (strict fidelity) | `shadcn-ui-design` | `shadcn-figma-starter-batch2/DESIGN.md`; skill `references/` (figma-workflow, critical-rules, tokens) |
